...
def get_best_alternates(client_id: int) -> list[BestAlternateRead]:
    ...
    if client_id == 1:
        ...
        # Real CleanDesign.ca best alternates from production
        return [
            BestAlternateRead(
                id=1,
                client_id=7,
    ...
    if client_id == 1:
        ...
        return [
            ...
            BlogIdeaRead(
                id=3,
                client_id=2,
                topic="Healthcare Digital Marketing Strategy for HIPAA-Safe, EMR-Verified ROI: Connecting Ads, Website Journeys, and Patient Reven",
                keyword_set_id=3,
                state="unqueued",
                error_message=None,
                brief_json=None,
...
def get_blog_idea_html(blog_idea_id: int, version_number: int | None = None) -> dict | None:
    ...
    # Client 2 blog ideas (Setsail)
        ...
        topics = {
            ...
            3: "Healthcare Digital Marketing Strategy for HIPAA-Safe, EMR-Verified ROI: Connecting Ads, Website Journeys, and Patient Reven",
        }
