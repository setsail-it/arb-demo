...
def get_keyword_ideas(client_id: int) -> list[KeywordIdeaRead]:
    ...
    if client_id == 1:
        ...
        # Real Setsail keyword ideas from production
        return [
            KeywordIdeaRead(
                id=1,
                client_id=2,
                keyword="full funnel marketing strategy",
                source="ai",
                search_volume=260,
            ...
            KeywordIdeaRead(
                id=3,
                client_id=2,
                keyword="digital marketing for real estate agents",
                source="ai",
                search_volume=390,
            ...
            KeywordIdeaRead(
                id=4,
                client_id=2,
                keyword="healthcare digital marketing strategy",
                source="ai",
                search_volume=210,
            ...
            KeywordIdeaRead(
                id=5,
                client_id=2,
                keyword="b2b saas lead generation",
                source="ai",
                search_volume=320,
            ...
            KeywordIdeaRead(
                id=6,
                client_id=2,
                keyword="marketing dashboard examples",
                source="ai",
                search_volume=320,
            ...
            KeywordIdeaRead(
                id=7,
                client_id=2,
                keyword="digital marketing for nonprofits",
                source="ai",
                search_volume=480,
            ...
            KeywordIdeaRead(
                id=10,
                client_id=2,
                keyword="digital marketing for law firms",
                source="ai",
                search_volume=1000,
        ...
        # Real CleanDesign.ca keyword ideas from production
        return [
            KeywordIdeaRead(
                id=1,
                client_id=7,
                keyword="generator efficiency",
                source="ai",
                search_volume=210,
            ...
            KeywordIdeaRead(
                id=10,
                client_id=7,
                keyword="generator maintenance checklist",
                source="ai",
                search_volume=480,
                keyword_difficulty=0,
                created_at=_base_time,
            ...
            KeywordIdeaRead(
                id=11,
                client_id=7,
                keyword="diesel generator maintenance",
                source="ai",
                search_volume=480,
                keyword_difficulty=0,
                created_at=_base_time,
            ...
            KeywordIdeaRead(
                id=12,
                client_id=7,
                keyword="diesel generator efficiency",
                source="ai",
                search_volume=170,
            ...
            KeywordIdeaRead(
                id=13,
                client_id=7,
                keyword="generator fuel efficiency",
                source="ai",
                search_volume=140,
                keyword_difficulty=0,
                created_at=_base_time,
            ...
            KeywordIdeaRead(
                id=14,
                client_id=7,
                keyword="diesel generator fuel consumption",
                source="ai",
                search_volume=110,
                keyword_difficulty=0,
                created_at=_base_time,
            ...
            KeywordIdeaRead(
                id=16,
                client_id=7,
                keyword="EV charging load management",
                source="ai",
                search_volume=90,
                keyword_difficulty=0,
                created_at=_base_time,
            ...
            KeywordIdeaRead(
                id=17,
                client_id=7,
                keyword="EV charging station design",
                source="ai",
                search_volume=90,
                keyword_difficulty=0,
                created_at=_base_time,
...
def get_keyword_sets(client_id: int) -> list[KeywordSetRead]:
    ...
    if client_id == 1:
        ...
        # Real Setsail keyword sets from production
        return [
            KeywordSetRead(
                id=1,
                client_id=2,
                primary_keyword="full funnel marketing strategy",
                primary_search_volume=260,
                primary_keyword_difficulty=18,
                primary_intent=None,
                primary_quality=None,
                secondaries=[
                    {"keyword": "full funnel", "sv": 480, "kd": None},
                    {"keyword": "full funnel marketing", "sv": 720, "kd": None},
                    {"keyword": "full funnel marketing strategy", "sv": 260, "kd": None},
                ],
                created_at=_base_time,
                updated_at=_base_time,
            ),
            KeywordSetRead(
                id=2,
                client_id=2,
                primary_keyword="digital marketing for real estate agents",
                primary_search_volume=390,
                primary_keyword_difficulty=3,
                primary_intent=None,
                primary_quality=None,
                secondaries=[
                    {"keyword": "real estate digital marketing agency", "sv": 590, "kd": None},
                    {"keyword": "digital marketing for real estate agents", "sv": 390, "kd": None},
                    {"keyword": "digital marketing for realtors", "sv": 390, "kd": None},
                ],
                created_at=_base_time,
                updated_at=_base_time,
            ),
            KeywordSetRead(
                id=3,
                client_id=2,
                primary_keyword="healthcare digital marketing strategy",
                primary_search_volume=210,
                primary_keyword_difficulty=15,
                primary_intent=None,
                primary_quality=None,
                secondaries=[
                    {"keyword": "healthcare digital marketing strategy", "sv": 210, "kd": None},
                    {"keyword": "healthcare seo agency", "sv": 880, "kd": None},
                ],
                created_at=_base_time,
                updated_at=_base_time,
            ),
            KeywordSetRead(
                id=4,
                client_id=2,
                primary_keyword="marketing dashboard examples",
                primary_search_volume=320,
                primary_keyword_difficulty=17,
                primary_intent=None,
                primary_quality=None,
                secondaries=[
                    {"keyword": "marketing dashboard examples", "sv": 320, "kd": None},
                    {"keyword": "example of marketing dashboard", "sv": 320, "kd": None},
                    {"keyword": "sample marketing dashboard", "sv": 320, "kd": None},
                ],
                created_at=_base_time,
                updated_at=_base_time,
            ),
        ...
        # Real CleanDesign.ca keyword sets from production
        return [
            KeywordSetRead(
                id=1,
                client_id=7,
                primary_keyword="power factor correction",
                primary_search_volume=1600,
                primary_keyword_difficulty=11,
                primary_intent=None,
                primary_quality=None,
                secondaries=[
                    {"keyword": "automatic power factor controller", "sv": 1900, "kd": None},
                    {"keyword": "power factor correction capacitor", "sv": 2900, "kd": None},
                    {"keyword": "pfc capacitor", "sv": 2900, "kd": None},
                ],
                created_at=_base_time,
                updated_at=_base_time,
            ),
...
def get_best_alternates(client_id: int) -> list[BestAlternateRead]:
    ...
    if client_id == 1:
        ...
        # Real Setsail best alternates from production
        return [
            BestAlternateRead(
                id=1,
                client_id=2,
                original_keyword_id=8,
            ...
            BestAlternateRead(
                id=10,
                client_id=2,
                original_keyword_id=6,
                keyword="social media dashboard",
                search_volume=720,
        ...
        # Real CleanDesign.ca best alternates from production (18 items)
        return [
            BestAlternateRead(
                id=1,
                client_id=7,
            ...
            BestAlternateRead(
                ...
                client_id=7,
                original_keyword_id=4,
                keyword="power factor correction capacitor",
                search_volume=2900,
                keyword_difficulty=1,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=6,
                client_id=7,
                original_keyword_id=16,
                keyword="load management ev charging",
                search_volume=110,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=8,
                client_id=7,
                original_keyword_id=13,
                keyword="generator fuel",
                search_volume=1000,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=10,
                client_id=7,
                original_keyword_id=14,
                keyword="diesel generator repair",
                search_volume=480,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=13,
                client_id=7,
                original_keyword_id=11,
                keyword="generac generator maintenance",
                search_volume=5400,
            ...
            BestAlternateRead(
                id=15,
                client_id=7,
                original_keyword_id=17,
                keyword="commercial ev charging station",
                search_volume=3600,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=16,
                client_id=7,
                original_keyword_id=12,
                keyword="diesel backup generator",
                search_volume=880,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
            ...
            BestAlternateRead(
                id=18,
                client_id=7,
                original_keyword_id=15,
                keyword="alternate power systems",
                search_volume=140,
                keyword_difficulty=0,
                is_original=False,
                created_at=_base_time,
...
def get_blog_ideas(client_id: int) -> list[BlogIdeaRead]:
    ...
    if client_id == 1:
        ...
        # Real Setsail blog ideas from production
        return [
            BlogIdeaRead(
                id=1,
                client_id=2,
                topic="Full funnel marketing strategy when PPC plateaus: scale beyond branded search without tanking ROAS",
                keyword_set_id=1,
                state="unqueued",
                error_message=None,
                brief_json=None,
                latest_sq_report=None,
                iteration_count=0,
                draft_html=None,
                created_at=_base_time,
                updated_at=_base_time,
            ...
            BlogIdeaRead(
                id=2,
                client_id=2,
                topic="Digital Marketing for Real Estate Agents: Engineering a Predictable Cost Per Closing Across PPC, Portals, and Referrals",
                keyword_set_id=2,
                state="unqueued",
                error_message=None,
                brief_json=None,
            ...
            BlogIdeaRead(
                id=3,
                client_id=2,
                topic="Healthcare Digital Marketing Strategy for HIPAA-Safe, EMR-Verified ROI: Connecting Ads, Website Journeys, and Patient Revenue",
                keyword_set_id=3,
                state="unqueued",
                error_message=None,
                brief_json=None,
        ...
        # Real CleanDesign.ca blog ideas for Blogger Automation
        return [
            BlogIdeaRead(
                id=1,
                client_id=7,
                topic="Power factor correction as a hidden capacity upgrade for mission‑critical microgrids: unlocking 20–30% more real power without new generators or grid upgrades",
                keyword_set_id=1,
                state="unqueued",
                error_message=None,
                brief_json=None,
...
def get_blog_idea_html(blog_idea_id: int, version_number: int | None = None) -> dict | None:
    ...
    # Client 2 blog ideas (Setsail)
    elif blog_idea_id in [1, 2, 3]:  # Setsail blog ideas
        topics = {
            1: "Full funnel marketing strategy when PPC plateaus: scale beyond branded search without tanking ROAS",
            2: "Digital Marketing for Real Estate Agents: Engineering a Predictable Cost Per Closing Across PPC, Portals, and Referrals",
            3: "Healthcare Digital Marketing Strategy for HIPAA-Safe, EMR-Verified ROI: Connecting Ads, Website Journeys, and Patient Revenue",
        }
        topic = topics.get(blog_idea_id, "Demo Blog Post")
        return {
            "blog_idea_id": blog_idea_id,
            "version_number": version,
            "html": f"<h1>{topic}</h1><p>Demo HTML content for Setsail blog post...</p>",
        }
    # Client 7 blog ideas (CleanDesign.ca)
    elif blog_idea_id == 1:  # CleanDesign blog idea
        topic = "Power factor correction as a hidden capacity upgrade for mission‑critical microgrids: unlocking 20–30% more real power without new generators or grid upgrades"
        return {
            "blog_idea_id": blog_idea_id,
            "version_number": version,
            "html": f"<h1>{topic}</h1><p>Demo HTML content for CleanDesign blog post...</p>",
        }
    return None
